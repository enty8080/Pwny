...
TOKEN_MAKE = tlv_custom_tag(API_CALL_STATIC, TOKEN_BASE, API_CALL + 3)

TLV_TYPE_TOKEN_USER = tlv_custom_type(TLV_TYPE_STRING, TOKEN_BASE, API_TYPE)
TLV_TYPE_TOKEN_DOMAIN = tlv_custom_type(TLV_TYPE_STRING, TOKEN_BASE, API_TYPE + 1)
TLV_TYPE_TOKEN_PASS = tlv_custom_type(TLV_TYPE_STRING, TOKEN_BASE, API_TYPE + 2)
