...
TIMESTOMP_SET = tlv_custom_tag(API_CALL_STATIC, TIMESTOMP_BASE, API_CALL)
TIMESTOMP_GET = tlv_custom_tag(API_CALL_STATIC, TIMESTOMP_BASE, API_CALL + 1)

TLV_TYPE_TS_PATH = tlv_custom_type(TLV_TYPE_STRING, TIMESTOMP_BASE, API_TYPE)
TLV_TYPE_TS_MTIME = tlv_custom_type(TLV_TYPE_INT, TIMESTOMP_BASE, API_TYPE)
TLV_TYPE_TS_ATIME = tlv_custom_type(TLV_TYPE_INT, TIMESTOMP_BASE, API_TYPE + 1)
TLV_TYPE_TS_CTIME = tlv_custom_type(TLV_TYPE_INT, TIMESTOMP_BASE, API_TYPE + 2)
