...
NETSHARE_ENUM = tlv_custom_tag(API_CALL_STATIC, NETSHARE_BASE, API_CALL)
NETSESSION_ENUM = tlv_custom_tag(API_CALL_STATIC, NETSHARE_BASE, API_CALL + 1)

TLV_TYPE_SHARE_NAME = tlv_custom_type(TLV_TYPE_STRING, NETSHARE_BASE, API_TYPE)
TLV_TYPE_SHARE_PATH = tlv_custom_type(TLV_TYPE_STRING, NETSHARE_BASE, API_TYPE + 1)
TLV_TYPE_SHARE_REMARK = tlv_custom_type(TLV_TYPE_STRING, NETSHARE_BASE, API_TYPE + 2)
TLV_TYPE_SHARE_TYPE = tlv_custom_type(TLV_TYPE_INT, NETSHARE_BASE, API_TYPE)
TLV_TYPE_SHARE_GROUP = tlv_custom_type(TLV_TYPE_GROUP, NETSHARE_BASE, API_TYPE)

TLV_TYPE_SESSION_CLIENT = tlv_custom_type(TLV_TYPE_STRING, NETSHARE_BASE, API_TYPE + 3)
TLV_TYPE_SESSION_USER = tlv_custom_type(TLV_TYPE_STRING, NETSHARE_BASE, API_TYPE + 4)
TLV_TYPE_SESSION_TIME = tlv_custom_type(TLV_TYPE_INT, NETSHARE_BASE, API_TYPE + 1)
TLV_TYPE_SESSION_IDLE = tlv_custom_type(TLV_TYPE_INT, NETSHARE_BASE, API_TYPE + 2)
TLV_TYPE_SESSION_GROUP = tlv_custom_type(TLV_TYPE_GROUP, NETSHARE_BASE, API_TYPE + 1)
