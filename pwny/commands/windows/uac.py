...
UAC_INFO = tlv_custom_tag(API_CALL_STATIC, UAC_BASE, API_CALL)

TLV_TYPE_UAC_ELEVATED = tlv_custom_type(TLV_TYPE_INT, UAC_BASE, API_TYPE)
TLV_TYPE_UAC_INTEGRITY = tlv_custom_type(TLV_TYPE_INT, UAC_BASE, API_TYPE + 1)
TLV_TYPE_UAC_INTEGRITY_NAME = tlv_custom_type(TLV_TYPE_STRING, UAC_BASE, API_TYPE)
