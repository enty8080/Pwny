...
REGISTRY_READ = tlv_custom_tag(API_CALL_STATIC, REGISTRY_BASE, API_CALL)
REGISTRY_WRITE = tlv_custom_tag(API_CALL_STATIC, REGISTRY_BASE, API_CALL + 1)
REGISTRY_DELETE = tlv_custom_tag(API_CALL_STATIC, REGISTRY_BASE, API_CALL + 2)

TLV_TYPE_REG_HIVE = tlv_custom_type(TLV_TYPE_INT, REGISTRY_BASE, API_TYPE)
TLV_TYPE_REG_PATH = tlv_custom_type(TLV_TYPE_STRING, REGISTRY_BASE, API_TYPE)
TLV_TYPE_REG_KEY = tlv_custom_type(TLV_TYPE_STRING, REGISTRY_BASE, API_TYPE + 1)
TLV_TYPE_REG_TYPE = tlv_custom_type(TLV_TYPE_INT, REGISTRY_BASE, API_TYPE + 1)
TLV_TYPE_REG_VALUE = tlv_custom_type(TLV_TYPE_BYTES, REGISTRY_BASE, API_TYPE)
    ...
    def run(self, args):
        if args.read:
            ...
            if result.get_int(TLV_TYPE_STATUS) != TLV_STATUS_SUCCESS:
                self.print_error(f"Failed to read registry value!")
                return
            ...
            if args.key:
                ...
                self.print_success(f"Registry key deleted!")
